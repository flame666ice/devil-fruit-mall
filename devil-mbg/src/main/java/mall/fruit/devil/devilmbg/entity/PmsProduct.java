...
public class PmsProduct implements Serializable {
    ...
    private String detlTitle;

    private String detlDesc;

    @ApiModelProperty("产品详情网页内容")
    private String detlHtml;

    @ApiModelProperty("移动端网页详情")
    private String detlMobileHtml;
    ...
    public String getDetlTitle() {
        return detlTitle;
    }

    public void setDetlTitle(String detlTitle) {
        this.detlTitle = detlTitle;
    }

    public String getDetlDesc() {
        return detlDesc;
    }

    public void setDetlDesc(String detlDesc) {
        this.detlDesc = detlDesc;
    }

    public String getDetlHtml() {
        return detlHtml;
    }

    public void setDetlHtml(String detlHtml) {
        this.detlHtml = detlHtml;
    }

    public String getDetlMobileHtml() {
        return detlMobileHtml;
    }

    public void setDetlMobileHtml(String detlMobileHtml) {
        this.detlMobileHtml = detlMobileHtml;
    }
